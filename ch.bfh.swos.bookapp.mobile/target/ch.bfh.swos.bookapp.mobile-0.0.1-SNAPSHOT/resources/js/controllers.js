...
controllers.controller('BookController', ['$scope', 'Book', 'Author', '$http', function($scope, Book, Author, $http) {
...
controllers.controller('AuthorController', ['$scope', 'Author', '$http', function($scope, Author, $http) {
    $http.defaults.useXDomain = true;
