...
import ch.bfh.swos.bookapp.repository.index.BookIndexRepository;
...
public class DefaultBookService implements BookService {
	...
	public BookDTO create(BookDTO bookDto) {
		...
		bookIndexRepository.index(persistedBook);
